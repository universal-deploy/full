...
Extend [Universal Deploy](https://github.com/universal-deploy/universal-deploy): **deeper** integration between Vite aps and deployment — support more features like SPA fallback, async jobs, ...
